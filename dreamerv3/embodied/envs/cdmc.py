...
class CDMC(embodied.Env):
  ...
  def __init__(self, env, repeat=1, render=True, size=(64, 64), camera=-1,
               unconstrain_at_step=5e5):

    print("CDMC repeat", repeat)
    unconstrain_at_step = unconstrain_at_step // repeat
    ...
    if isinstance(env, str):
      ...
      self._dmenv.task._unconstrain_at_step = unconstrain_at_step
